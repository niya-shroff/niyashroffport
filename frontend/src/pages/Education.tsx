            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <div className="flex items-center gap-3 tape-edge bg-surface p-4 border border-gray-800 rotate-[1deg] inline-block mb-4">
                        ...
                        <h2 className="text-2xl font-mono text-gray-900 dark:text-white tracking-widest uppercase">ACADEMIC_LOGS</h2>
                    </div>
                    ...
                    {education.map((edu, index) => (
                        ...
                        >
                            ...
                            <div className="lg:col-span-5 card p-8 h-full bg-surface/80 backdrop-blur border-l-2 border-l-accent-emerald">
                                <h3 className="text-xl font-bold font-sans text-gray-900 dark:text-white mb-2 uppercase">{edu.degree}</h3>
                                ...
                                <div className="space-y-3 font-mono text-xs text-muted mb-6">
                                    ...
                                    {edu.location && (
                                        <div className="flex items-center gap-2">
                                            <MapPin size={14} className="text-gray-600 dark:text-gray-500" />
                                        ...
                                        <div className="mb-8 border-b border-gray-800 pb-6">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {edu.courses.map((course, courseIndex) => (
                                                    <span
                                                        key={courseIndex}
                                                        className="font-mono text-[10px] text-gray-700 dark:text-gray-300 border border-gray-700 px-2 py-1 uppercase"
                                                    >
                                                        {course}
                                                    </span>
                                                ))}
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                {edu.activities.map((activity, actIndex) => (
                                                    <div key={actIndex} className="bg-background border border-gray-800 p-3 hover:border-primary/50 transition-colors">
                                                        ...
                                                        <p className="text-gray-600 dark:text-gray-400 text-xs leading-relaxed font-sans">{activity.description}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>

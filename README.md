...
- **Dynamic Content Integration**: Live fetches Substack articles from a secure backend API endpoint directly into the text archive.
- **Project Terminal**: Visualized GitHub repository activity logging.
- **Secure Comm Link**: Working contact forms powered by EmailJS integrations.
- **Animated Layouts**: Smooth Framer Motion page transitions and custom layered floating 3D cards using built-in perspective transformations.

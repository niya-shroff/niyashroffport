    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative cinematic-vignette spotlight">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-primary text-lg mb-4 animate-fade-in min-h-[28px] flex items-center justify-center">
            <span>
              {displayText}
              <span className={`inline-block w-0.5 h-5 bg-primary ml-1 ${isTyping ? 'animate-pulse' : 'animate-ping'}`}></span>
            </span>
          </p>
          ...
          <div className="flex justify-center animate-bounce">
            <a href="#about" className="text-gray-400 hover:text-primary transition-colors duration-200 flex items-center justify-center">
              <ChevronDown size={24} />
            </a>
          </div>
        </div>
